...
function createWebpackMiddleware() {
  ...
  this.webpackDevMiddleware = __WEBPACK_IMPORTED_MODULE_8_pify___default()(__webpack_require__(54)(clientCompiler, {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    n = 0;
                    _context2.next = 3;
                    return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.all(routes.splice(0, 1).map(function () {
...
var Module = function () {
  ...
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default()(Module, [{
    ...
    key: 'addModule',
    value: function addModule(moduleOpts) {
      var _this = this;
